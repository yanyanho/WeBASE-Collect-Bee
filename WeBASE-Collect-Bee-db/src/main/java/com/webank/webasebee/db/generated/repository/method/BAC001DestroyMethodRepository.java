...
import com.webank.webasebee.db.generated.entity.method.BAC001Destroy;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001DestroyMethodRepository extends JpaRepository<BAC001Destroy, Long>, JpaSpecificationExecutor<BAC001Destroy>, RollbackInterface {
	BAC001Destroy findByTxHash(String txHash);
