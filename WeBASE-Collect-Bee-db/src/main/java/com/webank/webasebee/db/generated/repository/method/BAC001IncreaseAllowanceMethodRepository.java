...
import com.webank.webasebee.db.generated.entity.method.BAC001IncreaseAllowance;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001IncreaseAllowanceMethodRepository extends JpaRepository<BAC001IncreaseAllowance, Long>, JpaSpecificationExecutor<BAC001IncreaseAllowance>, RollbackInterface {
	BAC001IncreaseAllowance findByTxHash(String txHash);
