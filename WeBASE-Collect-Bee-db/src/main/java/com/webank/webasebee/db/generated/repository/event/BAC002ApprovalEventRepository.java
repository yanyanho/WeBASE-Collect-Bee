...
import com.webank.webasebee.db.generated.entity.event.BAC002Approval;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002ApprovalEventRepository extends JpaRepository<BAC002Approval, Long>, JpaSpecificationExecutor<BAC002Approval>, RollbackInterface {
	public BAC002Approval findTopByOrderByBlockHeightDesc();
