...
@Entity(name = "b_a_c002_un_suspended_event")
@Table(name = "b_a_c002_un_suspended_event", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class BAC002UnSuspended extends IdEntity {
