...
import com.webank.webasebee.db.generated.entity.method.BAC001Send;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SendMethodRepository extends JpaRepository<BAC001Send, Long>, JpaSpecificationExecutor<BAC001Send>, RollbackInterface {
	BAC001Send findByTxHash(String txHash);
