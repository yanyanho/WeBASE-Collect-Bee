...
import com.webank.webasebee.db.generated.entity.method.BAC001SafeSend;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SafeSendMethodRepository extends JpaRepository<BAC001SafeSend, Long>, JpaSpecificationExecutor<BAC001SafeSend>, RollbackInterface {
	BAC001SafeSend findByTxHash(String txHash);
