...
import com.webank.webasebee.db.generated.entity.method.BAC001Issue;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001IssueMethodRepository extends JpaRepository<BAC001Issue, Long>, JpaSpecificationExecutor<BAC001Issue>, RollbackInterface {
	BAC001Issue findByTxHash(String txHash);
