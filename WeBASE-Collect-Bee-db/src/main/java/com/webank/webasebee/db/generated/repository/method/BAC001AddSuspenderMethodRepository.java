...
import com.webank.webasebee.db.generated.entity.method.BAC001AddSuspender;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001AddSuspenderMethodRepository extends JpaRepository<BAC001AddSuspender, Long>, JpaSpecificationExecutor<BAC001AddSuspender>, RollbackInterface {
	BAC001AddSuspender findByTxHash(String txHash);
