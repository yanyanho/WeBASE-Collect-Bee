...
import com.webank.webasebee.db.generated.entity.method.BAC002SetApprovalForAll;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002SetApprovalForAllMethodRepository extends JpaRepository<BAC002SetApprovalForAll, Long>, JpaSpecificationExecutor<BAC002SetApprovalForAll>, RollbackInterface {
	BAC002SetApprovalForAll findByTxHash(String txHash);
