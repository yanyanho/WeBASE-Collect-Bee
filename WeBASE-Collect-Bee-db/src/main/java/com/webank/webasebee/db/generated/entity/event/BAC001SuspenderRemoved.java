...
@Entity(name = "b_a_c001_suspender_removed_event")
@Table(name = "b_a_c001_suspender_removed_event", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class BAC001SuspenderRemoved extends IdEntity {
