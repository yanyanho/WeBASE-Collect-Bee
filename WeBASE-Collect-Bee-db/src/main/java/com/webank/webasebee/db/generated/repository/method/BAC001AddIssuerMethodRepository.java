...
import com.webank.webasebee.db.generated.entity.method.BAC001AddIssuer;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001AddIssuerMethodRepository extends JpaRepository<BAC001AddIssuer, Long>, JpaSpecificationExecutor<BAC001AddIssuer>, RollbackInterface {
	BAC001AddIssuer findByTxHash(String txHash);
