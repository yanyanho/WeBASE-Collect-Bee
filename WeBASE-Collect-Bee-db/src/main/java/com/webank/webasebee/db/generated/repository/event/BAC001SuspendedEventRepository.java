...
import com.webank.webasebee.db.generated.entity.event.BAC001Suspended;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SuspendedEventRepository extends JpaRepository<BAC001Suspended, Long>, JpaSpecificationExecutor<BAC001Suspended>, RollbackInterface {
	public BAC001Suspended findTopByOrderByBlockHeightDesc();
