...
import com.webank.webasebee.db.generated.entity.event.BAC001SuspenderAdded;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SuspenderAddedEventRepository extends JpaRepository<BAC001SuspenderAdded, Long>, JpaSpecificationExecutor<BAC001SuspenderAdded>, RollbackInterface {
	public BAC001SuspenderAdded findTopByOrderByBlockHeightDesc();
