...
import com.webank.webasebee.db.generated.entity.method.BAC001BAC001;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001BAC001MethodRepository extends JpaRepository<BAC001BAC001, Long>, JpaSpecificationExecutor<BAC001BAC001>, RollbackInterface {
	BAC001BAC001 findByTxHash(String txHash);
