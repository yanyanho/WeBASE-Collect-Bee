...
import com.webank.webasebee.db.generated.entity.method.BAC003Create;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003CreateMethodRepository extends JpaRepository<BAC003Create, Long>, JpaSpecificationExecutor<BAC003Create>, RollbackInterface {
	BAC003Create findByTxHash(String txHash);
