...
import com.webank.webasebee.db.generated.entity.event.BAC001Send;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SendEventRepository extends JpaRepository<BAC001Send, Long>, JpaSpecificationExecutor<BAC001Send>, RollbackInterface {
	public BAC001Send findTopByOrderByBlockHeightDesc();
