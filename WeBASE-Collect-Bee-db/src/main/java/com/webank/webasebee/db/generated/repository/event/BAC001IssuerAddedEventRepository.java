...
import com.webank.webasebee.db.generated.entity.event.BAC001IssuerAdded;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001IssuerAddedEventRepository extends JpaRepository<BAC001IssuerAdded, Long>, JpaSpecificationExecutor<BAC001IssuerAdded>, RollbackInterface {
	public BAC001IssuerAdded findTopByOrderByBlockHeightDesc();
