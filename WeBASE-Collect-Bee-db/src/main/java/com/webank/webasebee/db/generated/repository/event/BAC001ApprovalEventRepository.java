...
import com.webank.webasebee.db.generated.entity.event.BAC001Approval;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001ApprovalEventRepository extends JpaRepository<BAC001Approval, Long>, JpaSpecificationExecutor<BAC001Approval>, RollbackInterface {
	public BAC001Approval findTopByOrderByBlockHeightDesc();
