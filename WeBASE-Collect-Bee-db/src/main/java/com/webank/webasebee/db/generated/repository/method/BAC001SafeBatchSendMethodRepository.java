...
import com.webank.webasebee.db.generated.entity.method.BAC001SafeBatchSend;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SafeBatchSendMethodRepository extends JpaRepository<BAC001SafeBatchSend, Long>, JpaSpecificationExecutor<BAC001SafeBatchSend>, RollbackInterface {
	BAC001SafeBatchSend findByTxHash(String txHash);
