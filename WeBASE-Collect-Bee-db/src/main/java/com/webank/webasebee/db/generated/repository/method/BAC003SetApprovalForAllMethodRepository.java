...
import com.webank.webasebee.db.generated.entity.method.BAC003SetApprovalForAll;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003SetApprovalForAllMethodRepository extends JpaRepository<BAC003SetApprovalForAll, Long>, JpaSpecificationExecutor<BAC003SetApprovalForAll>, RollbackInterface {
	BAC003SetApprovalForAll findByTxHash(String txHash);
