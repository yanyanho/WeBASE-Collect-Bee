...
import com.webank.webasebee.db.generated.entity.method.BAC002AddIssuer;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002AddIssuerMethodRepository extends JpaRepository<BAC002AddIssuer, Long>, JpaSpecificationExecutor<BAC002AddIssuer>, RollbackInterface {
	BAC002AddIssuer findByTxHash(String txHash);
