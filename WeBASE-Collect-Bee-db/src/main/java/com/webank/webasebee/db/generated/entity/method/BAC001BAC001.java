...
@Entity(name = "b_a_c001_b_a_c001_method")
@Table(name = "b_a_c001_b_a_c001_method", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class BAC001BAC001 extends IdEntity {
	...
	@Column(name = "_short_name")
	private String shortName;
	@Column(name = "_min_unit")
	private int minUnit;
