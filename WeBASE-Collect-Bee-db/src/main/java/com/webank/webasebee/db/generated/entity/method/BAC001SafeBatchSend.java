...
@Entity(name = "b_a_c001_safe_batch_send_method")
@Table(name = "b_a_c001_safe_batch_send_method", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class BAC001SafeBatchSend extends IdEntity {
