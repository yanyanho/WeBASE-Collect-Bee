...
import com.webank.webasebee.db.generated.entity.method.BAC003SafeBatchTransferFrom;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003SafeBatchTransferFromMethodRepository extends JpaRepository<BAC003SafeBatchTransferFrom, Long>, JpaSpecificationExecutor<BAC003SafeBatchTransferFrom>, RollbackInterface {
	BAC003SafeBatchTransferFrom findByTxHash(String txHash);
