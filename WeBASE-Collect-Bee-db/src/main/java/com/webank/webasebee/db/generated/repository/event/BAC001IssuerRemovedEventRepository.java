...
import com.webank.webasebee.db.generated.entity.event.BAC001IssuerRemoved;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001IssuerRemovedEventRepository extends JpaRepository<BAC001IssuerRemoved, Long>, JpaSpecificationExecutor<BAC001IssuerRemoved>, RollbackInterface {
	public BAC001IssuerRemoved findTopByOrderByBlockHeightDesc();
