...
import com.webank.webasebee.db.generated.entity.event.BAC002UnSuspended;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002UnSuspendedEventRepository extends JpaRepository<BAC002UnSuspended, Long>, JpaSpecificationExecutor<BAC002UnSuspended>, RollbackInterface {
	public BAC002UnSuspended findTopByOrderByBlockHeightDesc();
