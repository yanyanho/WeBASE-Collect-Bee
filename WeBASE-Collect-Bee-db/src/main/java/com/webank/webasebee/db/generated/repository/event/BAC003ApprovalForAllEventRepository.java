...
import com.webank.webasebee.db.generated.entity.event.BAC003ApprovalForAll;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003ApprovalForAllEventRepository extends JpaRepository<BAC003ApprovalForAll, Long>, JpaSpecificationExecutor<BAC003ApprovalForAll>, RollbackInterface {
	public BAC003ApprovalForAll findTopByOrderByBlockHeightDesc();
