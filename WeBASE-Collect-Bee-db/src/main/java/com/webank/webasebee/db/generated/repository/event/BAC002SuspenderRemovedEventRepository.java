...
import com.webank.webasebee.db.generated.entity.event.BAC002SuspenderRemoved;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002SuspenderRemovedEventRepository extends JpaRepository<BAC002SuspenderRemoved, Long>, JpaSpecificationExecutor<BAC002SuspenderRemoved>, RollbackInterface {
	public BAC002SuspenderRemoved findTopByOrderByBlockHeightDesc();
