...
import com.webank.webasebee.db.generated.entity.event.BAC001UnSuspended;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001UnSuspendedEventRepository extends JpaRepository<BAC001UnSuspended, Long>, JpaSpecificationExecutor<BAC001UnSuspended>, RollbackInterface {
	public BAC001UnSuspended findTopByOrderByBlockHeightDesc();
