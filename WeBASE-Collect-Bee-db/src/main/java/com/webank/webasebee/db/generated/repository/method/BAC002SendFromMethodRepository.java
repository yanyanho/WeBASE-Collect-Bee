...
import com.webank.webasebee.db.generated.entity.method.BAC002SendFrom;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002SendFromMethodRepository extends JpaRepository<BAC002SendFrom, Long>, JpaSpecificationExecutor<BAC002SendFrom>, RollbackInterface {
	BAC002SendFrom findByTxHash(String txHash);
