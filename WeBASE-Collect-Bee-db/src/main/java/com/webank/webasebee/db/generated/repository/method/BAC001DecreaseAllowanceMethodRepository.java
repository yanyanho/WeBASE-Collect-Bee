...
import com.webank.webasebee.db.generated.entity.method.BAC001DecreaseAllowance;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001DecreaseAllowanceMethodRepository extends JpaRepository<BAC001DecreaseAllowance, Long>, JpaSpecificationExecutor<BAC001DecreaseAllowance>, RollbackInterface {
	BAC001DecreaseAllowance findByTxHash(String txHash);
