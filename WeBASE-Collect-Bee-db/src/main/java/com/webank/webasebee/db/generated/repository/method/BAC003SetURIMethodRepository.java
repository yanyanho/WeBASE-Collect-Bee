...
import com.webank.webasebee.db.generated.entity.method.BAC003SetURI;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003SetURIMethodRepository extends JpaRepository<BAC003SetURI, Long>, JpaSpecificationExecutor<BAC003SetURI>, RollbackInterface {
	BAC003SetURI findByTxHash(String txHash);
