...
import com.webank.webasebee.db.generated.entity.method.BAC002Destroy;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002DestroyMethodRepository extends JpaRepository<BAC002Destroy, Long>, JpaSpecificationExecutor<BAC002Destroy>, RollbackInterface {
	BAC002Destroy findByTxHash(String txHash);
