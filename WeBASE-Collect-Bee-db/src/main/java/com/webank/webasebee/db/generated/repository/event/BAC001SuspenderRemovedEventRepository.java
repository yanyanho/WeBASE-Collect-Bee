...
import com.webank.webasebee.db.generated.entity.event.BAC001SuspenderRemoved;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SuspenderRemovedEventRepository extends JpaRepository<BAC001SuspenderRemoved, Long>, JpaSpecificationExecutor<BAC001SuspenderRemoved>, RollbackInterface {
	public BAC001SuspenderRemoved findTopByOrderByBlockHeightDesc();
