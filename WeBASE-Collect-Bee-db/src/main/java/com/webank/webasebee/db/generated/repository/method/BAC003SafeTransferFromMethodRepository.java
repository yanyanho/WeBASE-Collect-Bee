...
import com.webank.webasebee.db.generated.entity.method.BAC003SafeTransferFrom;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003SafeTransferFromMethodRepository extends JpaRepository<BAC003SafeTransferFrom, Long>, JpaSpecificationExecutor<BAC003SafeTransferFrom>, RollbackInterface {
	BAC003SafeTransferFrom findByTxHash(String txHash);
