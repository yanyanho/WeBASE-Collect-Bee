...
import com.webank.webasebee.db.generated.entity.method.BAC002SafeBatchSendFrom;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002SafeBatchSendFromMethodRepository extends JpaRepository<BAC002SafeBatchSendFrom, Long>, JpaSpecificationExecutor<BAC002SafeBatchSendFrom>, RollbackInterface {
	BAC002SafeBatchSendFrom findByTxHash(String txHash);
