...
@Entity(name = "b_a_c002_issue_with_asset_u_r_i_method")
@Table(name = "b_a_c002_issue_with_asset_u_r_i_method", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class BAC002IssueWithAssetURI extends IdEntity {
