...
import com.webank.webasebee.db.generated.entity.event.BAC003TransferBatch;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003TransferBatchEventRepository extends JpaRepository<BAC003TransferBatch, Long>, JpaSpecificationExecutor<BAC003TransferBatch>, RollbackInterface {
	public BAC003TransferBatch findTopByOrderByBlockHeightDesc();
