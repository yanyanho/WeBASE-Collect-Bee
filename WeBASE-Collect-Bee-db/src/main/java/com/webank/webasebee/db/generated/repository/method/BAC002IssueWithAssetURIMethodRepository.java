...
import com.webank.webasebee.db.generated.entity.method.BAC002IssueWithAssetURI;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002IssueWithAssetURIMethodRepository extends JpaRepository<BAC002IssueWithAssetURI, Long>, JpaSpecificationExecutor<BAC002IssueWithAssetURI>, RollbackInterface {
	BAC002IssueWithAssetURI findByTxHash(String txHash);
