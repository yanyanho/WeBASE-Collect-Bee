...
import com.webank.webasebee.db.generated.entity.method.BAC001Approve;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001ApproveMethodRepository extends JpaRepository<BAC001Approve, Long>, JpaSpecificationExecutor<BAC001Approve>, RollbackInterface {
	BAC001Approve findByTxHash(String txHash);
