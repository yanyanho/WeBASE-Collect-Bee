...
import com.webank.webasebee.db.generated.entity.method.BAC001SafeSendFrom;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001SafeSendFromMethodRepository extends JpaRepository<BAC001SafeSendFrom, Long>, JpaSpecificationExecutor<BAC001SafeSendFrom>, RollbackInterface {
	BAC001SafeSendFrom findByTxHash(String txHash);
