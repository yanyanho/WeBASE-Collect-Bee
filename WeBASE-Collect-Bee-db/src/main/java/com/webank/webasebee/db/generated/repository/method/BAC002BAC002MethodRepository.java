...
import com.webank.webasebee.db.generated.entity.method.BAC002BAC002;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002BAC002MethodRepository extends JpaRepository<BAC002BAC002, Long>, JpaSpecificationExecutor<BAC002BAC002>, RollbackInterface {
	BAC002BAC002 findByTxHash(String txHash);
