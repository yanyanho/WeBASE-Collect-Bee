...
import com.webank.webasebee.db.generated.entity.event.BAC002SuspenderAdded;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC002SuspenderAddedEventRepository extends JpaRepository<BAC002SuspenderAdded, Long>, JpaSpecificationExecutor<BAC002SuspenderAdded>, RollbackInterface {
	public BAC002SuspenderAdded findTopByOrderByBlockHeightDesc();
