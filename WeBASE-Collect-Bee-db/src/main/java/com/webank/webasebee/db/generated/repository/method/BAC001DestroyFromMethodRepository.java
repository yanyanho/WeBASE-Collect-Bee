...
import com.webank.webasebee.db.generated.entity.method.BAC001DestroyFrom;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC001DestroyFromMethodRepository extends JpaRepository<BAC001DestroyFrom, Long>, JpaSpecificationExecutor<BAC001DestroyFrom>, RollbackInterface {
	BAC001DestroyFrom findByTxHash(String txHash);
