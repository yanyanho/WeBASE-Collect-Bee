...
import com.webank.webasebee.db.generated.entity.method.BAC003Increase;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface BAC003IncreaseMethodRepository extends JpaRepository<BAC003Increase, Long>, JpaSpecificationExecutor<BAC003Increase>, RollbackInterface {
	BAC003Increase findByTxHash(String txHash);
