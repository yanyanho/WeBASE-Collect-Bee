CREATE TABLE b_a_c002_safe_batch_send_from_method (
	...
	_to text NOT NULL,
	_asset_id text NOT NULL,
	_data varchar(512) NOT NULL,
  	`updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
 	PRIMARY KEY (pk_id)
) COMMENT='b_a_c002_safe_batch_send_from_method' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;