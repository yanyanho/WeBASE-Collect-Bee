...
import com.webank.webasebee.parser.generated.bo.method.BAC005AddIssuerBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.addIssuerMethodCrawlerService", havingValue = "on")
public class BAC005AddIssuerMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005AddIssuer Transaction");
		BAC005AddIssuerBO entity = new BAC005AddIssuerBO();
		...
		entity.setIdentifier("BAC005AddIssuer");			
		
		log.debug("end process BAC005AddIssuer Transaction");
		return entity;
	}
}
