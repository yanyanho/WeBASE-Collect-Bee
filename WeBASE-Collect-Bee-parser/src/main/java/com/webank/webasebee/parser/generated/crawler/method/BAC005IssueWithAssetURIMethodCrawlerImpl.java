...
import com.webank.webasebee.parser.generated.bo.method.BAC005IssueWithAssetURIBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.issueWithAssetURIMethodCrawlerService", havingValue = "on")
public class BAC005IssueWithAssetURIMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005IssueWithAssetURI Transaction");
		BAC005IssueWithAssetURIBO entity = new BAC005IssueWithAssetURIBO();
		...
		entity.setIdentifier("BAC005IssueWithAssetURI");			
		
		log.debug("end process BAC005IssueWithAssetURI Transaction");
		return entity;
	}
}
