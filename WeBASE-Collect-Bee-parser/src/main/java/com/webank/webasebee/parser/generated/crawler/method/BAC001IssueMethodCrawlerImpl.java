...
import com.webank.webasebee.parser.generated.bo.method.BAC001IssueBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.issueMethodCrawlerService", havingValue = "on")
public class BAC001IssueMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001Issue Transaction");
		BAC001IssueBO entity = new BAC001IssueBO();
		...
		entity.setIdentifier("BAC001Issue");			
		
		log.debug("end process BAC001Issue Transaction");
		return entity;
	}
}
