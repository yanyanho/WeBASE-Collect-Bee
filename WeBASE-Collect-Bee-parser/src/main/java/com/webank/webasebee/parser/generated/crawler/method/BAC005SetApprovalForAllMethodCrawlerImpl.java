...
import com.webank.webasebee.parser.generated.bo.method.BAC005SetApprovalForAllBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.setApprovalForAllMethodCrawlerService", havingValue = "on")
public class BAC005SetApprovalForAllMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005SetApprovalForAll Transaction");
		BAC005SetApprovalForAllBO entity = new BAC005SetApprovalForAllBO();
		...
		entity.setIdentifier("BAC005SetApprovalForAll");			
		
		log.debug("end process BAC005SetApprovalForAll Transaction");
		return entity;
	}
}
