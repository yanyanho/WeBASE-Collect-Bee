...
import com.webank.webasebee.parser.generated.bo.method.BAC001AddSuspenderBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.addSuspenderMethodCrawlerService", havingValue = "on")
public class BAC001AddSuspenderMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001AddSuspender Transaction");
		BAC001AddSuspenderBO entity = new BAC001AddSuspenderBO();
		...
		entity.setIdentifier("BAC001AddSuspender");			
		
		log.debug("end process BAC001AddSuspender Transaction");
		return entity;
	}
}
