...
import com.webank.webasebee.parser.generated.bo.method.BAC004BAC004BO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.BAC004MethodCrawlerService", havingValue = "on")
public class BAC004BAC004MethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004BAC004 Transaction");
		BAC004BAC004BO entity = new BAC004BAC004BO();
		...
		entity.setSymbol(String.valueOf(params.get(1).getValue()));
		...
		entity.setIdentifier("BAC004BAC004");			
		
		log.debug("end process BAC004BAC004 Transaction");
		return entity;
	}
}
