...
import com.webank.webasebee.parser.generated.bo.method.BAC004AddSuspenderBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.addSuspenderMethodCrawlerService", havingValue = "on")
public class BAC004AddSuspenderMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004AddSuspender Transaction");
		BAC004AddSuspenderBO entity = new BAC004AddSuspenderBO();
		...
		entity.setIdentifier("BAC004AddSuspender");			
		
		log.debug("end process BAC004AddSuspender Transaction");
		return entity;
	}
}
