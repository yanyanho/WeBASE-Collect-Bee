...
import com.webank.webasebee.parser.generated.bo.method.BAC002ApproveBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.approveMethodCrawlerService", havingValue = "on")
public class BAC002ApproveMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002Approve Transaction");
		BAC002ApproveBO entity = new BAC002ApproveBO();
		...
		entity.setIdentifier("BAC002Approve");			
		
		log.debug("end process BAC002Approve Transaction");
		return entity;
	}
}
