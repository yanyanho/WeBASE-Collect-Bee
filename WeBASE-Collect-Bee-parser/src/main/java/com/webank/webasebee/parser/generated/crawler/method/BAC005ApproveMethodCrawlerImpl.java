...
import com.webank.webasebee.parser.generated.bo.method.BAC005ApproveBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.approveMethodCrawlerService", havingValue = "on")
public class BAC005ApproveMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005Approve Transaction");
		BAC005ApproveBO entity = new BAC005ApproveBO();
		...
		entity.setIdentifier("BAC005Approve");			
		
		log.debug("end process BAC005Approve Transaction");
		return entity;
	}
}
