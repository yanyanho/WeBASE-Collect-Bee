...
import com.webank.webasebee.parser.generated.bo.method.BAC002SetApprovalForAllBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.setApprovalForAllMethodCrawlerService", havingValue = "on")
public class BAC002SetApprovalForAllMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002SetApprovalForAll Transaction");
		BAC002SetApprovalForAllBO entity = new BAC002SetApprovalForAllBO();
		...
		entity.setApproved(BoolUtils.toBoolean(params.get(1).getValue()));
		entity.setBlockTimeStamp(new Date(blockTimeStamp.longValue()));	
		entity.setIdentifier("BAC002SetApprovalForAll");			
		
		log.debug("end process BAC002SetApprovalForAll Transaction");
		return entity;
	}
}
