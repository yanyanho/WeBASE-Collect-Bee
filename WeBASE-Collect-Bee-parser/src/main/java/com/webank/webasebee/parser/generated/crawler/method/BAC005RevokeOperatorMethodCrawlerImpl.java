...
import com.webank.webasebee.parser.generated.bo.method.BAC005RevokeOperatorBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.revokeOperatorMethodCrawlerService", havingValue = "on")
public class BAC005RevokeOperatorMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005RevokeOperator Transaction");
		BAC005RevokeOperatorBO entity = new BAC005RevokeOperatorBO();
		...
		entity.setIdentifier("BAC005RevokeOperator");			
		
		log.debug("end process BAC005RevokeOperator Transaction");
		return entity;
	}
}
