...
import com.webank.webasebee.parser.generated.bo.method.BAC002BAC002BO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.BAC002MethodCrawlerService", havingValue = "on")
public class BAC002BAC002MethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002BAC002 Transaction");
		BAC002BAC002BO entity = new BAC002BAC002BO();
		...
		entity.setIdentifier("BAC002BAC002");			
		
		log.debug("end process BAC002BAC002 Transaction");
		return entity;
	}
}
