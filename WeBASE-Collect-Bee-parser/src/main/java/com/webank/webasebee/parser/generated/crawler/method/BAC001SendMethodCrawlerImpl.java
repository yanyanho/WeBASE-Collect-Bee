...
import com.webank.webasebee.parser.generated.bo.method.BAC001SendBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.sendMethodCrawlerService", havingValue = "on")
public class BAC001SendMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001Send Transaction");
		BAC001SendBO entity = new BAC001SendBO();
		...
		entity.setIdentifier("BAC001Send");			
		
		log.debug("end process BAC001Send Transaction");
		return entity;
	}
}
