...
import com.webank.webasebee.parser.generated.bo.method.BAC004ApproveBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.approveMethodCrawlerService", havingValue = "on")
public class BAC004ApproveMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004Approve Transaction");
		BAC004ApproveBO entity = new BAC004ApproveBO();
		...
		entity.setIdentifier("BAC004Approve");			
		
		log.debug("end process BAC004Approve Transaction");
		return entity;
	}
}
