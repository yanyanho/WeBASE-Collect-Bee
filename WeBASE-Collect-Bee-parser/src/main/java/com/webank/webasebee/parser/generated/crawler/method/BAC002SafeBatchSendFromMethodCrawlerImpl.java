...
import com.webank.webasebee.parser.generated.bo.method.BAC002SafeBatchSendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.safeBatchSendFromMethodCrawlerService", havingValue = "on")
public class BAC002SafeBatchSendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002SafeBatchSendFrom Transaction");
		BAC002SafeBatchSendFromBO entity = new BAC002SafeBatchSendFromBO();
		...
		entity.setIdentifier("BAC002SafeBatchSendFrom");			
		
		log.debug("end process BAC002SafeBatchSendFrom Transaction");
		return entity;
	}
}
