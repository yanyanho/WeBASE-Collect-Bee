...
import com.webank.webasebee.parser.generated.bo.method.BAC002AddSuspenderBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.addSuspenderMethodCrawlerService", havingValue = "on")
public class BAC002AddSuspenderMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002AddSuspender Transaction");
		BAC002AddSuspenderBO entity = new BAC002AddSuspenderBO();
		...
		entity.setIdentifier("BAC002AddSuspender");			
		
		log.debug("end process BAC002AddSuspender Transaction");
		return entity;
	}
}
