...
import com.webank.webasebee.parser.generated.bo.method.BAC004SendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.sendFromMethodCrawlerService", havingValue = "on")
public class BAC004SendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004SendFrom Transaction");
		BAC004SendFromBO entity = new BAC004SendFromBO();
		...
		entity.setHolder(AddressUtils.bigIntegerToString(params.get(0).getValue()));
		...
		entity.setIdentifier("BAC004SendFrom");			
		
		log.debug("end process BAC004SendFrom Transaction");
		return entity;
	}
}
