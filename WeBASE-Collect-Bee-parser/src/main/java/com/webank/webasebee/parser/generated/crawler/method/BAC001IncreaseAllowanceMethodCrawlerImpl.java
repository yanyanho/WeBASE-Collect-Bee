...
import com.webank.webasebee.parser.generated.bo.method.BAC001IncreaseAllowanceBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.increaseAllowanceMethodCrawlerService", havingValue = "on")
public class BAC001IncreaseAllowanceMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001IncreaseAllowance Transaction");
		BAC001IncreaseAllowanceBO entity = new BAC001IncreaseAllowanceBO();
		...
		entity.setAddedValue(BigIntegerUtils.toLong(params.get(1).getValue()));
		entity.setBlockTimeStamp(new Date(blockTimeStamp.longValue()));	
		entity.setIdentifier("BAC001IncreaseAllowance");			
		
		log.debug("end process BAC001IncreaseAllowance Transaction");
		return entity;
	}
}
