...
import com.webank.webasebee.parser.generated.bo.method.BAC001SendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.sendFromMethodCrawlerService", havingValue = "on")
public class BAC001SendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001SendFrom Transaction");
		BAC001SendFromBO entity = new BAC001SendFromBO();
		...
		entity.setIdentifier("BAC001SendFrom");			
		
		log.debug("end process BAC001SendFrom Transaction");
		return entity;
	}
}
