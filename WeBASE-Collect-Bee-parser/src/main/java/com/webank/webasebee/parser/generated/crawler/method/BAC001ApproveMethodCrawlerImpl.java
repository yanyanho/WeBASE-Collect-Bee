...
import com.webank.webasebee.parser.generated.bo.method.BAC001ApproveBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.approveMethodCrawlerService", havingValue = "on")
public class BAC001ApproveMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001Approve Transaction");
		BAC001ApproveBO entity = new BAC001ApproveBO();
		...
		entity.setIdentifier("BAC001Approve");			
		
		log.debug("end process BAC001Approve Transaction");
		return entity;
	}
}
