...
import com.webank.webasebee.parser.generated.bo.method.BAC005SendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.sendFromMethodCrawlerService", havingValue = "on")
public class BAC005SendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005SendFrom Transaction");
		BAC005SendFromBO entity = new BAC005SendFromBO();
		...
		entity.setIdentifier("BAC005SendFrom");			
		
		log.debug("end process BAC005SendFrom Transaction");
		return entity;
	}
}
