...
import com.webank.webasebee.parser.generated.bo.method.BAC003BAC003BO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC003.BAC003MethodCrawlerService", havingValue = "on")
public class BAC003BAC003MethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC003BAC003 Transaction");
		BAC003BAC003BO entity = new BAC003BAC003BO();
		...
		entity.setIdentifier("BAC003BAC003");			
		
		log.debug("end process BAC003BAC003 Transaction");
		return entity;
	}
}
