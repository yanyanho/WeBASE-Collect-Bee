...
import com.webank.webasebee.parser.generated.bo.method.BAC002AddIssuerBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.addIssuerMethodCrawlerService", havingValue = "on")
public class BAC002AddIssuerMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002AddIssuer Transaction");
		BAC002AddIssuerBO entity = new BAC002AddIssuerBO();
		...
		entity.setIdentifier("BAC002AddIssuer");			
		
		log.debug("end process BAC002AddIssuer Transaction");
		return entity;
	}
}
