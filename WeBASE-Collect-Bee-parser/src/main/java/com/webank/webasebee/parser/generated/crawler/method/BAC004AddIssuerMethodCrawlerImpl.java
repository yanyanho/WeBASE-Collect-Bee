...
import com.webank.webasebee.parser.generated.bo.method.BAC004AddIssuerBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.addIssuerMethodCrawlerService", havingValue = "on")
public class BAC004AddIssuerMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004AddIssuer Transaction");
		BAC004AddIssuerBO entity = new BAC004AddIssuerBO();
		...
		entity.setIdentifier("BAC004AddIssuer");			
		
		log.debug("end process BAC004AddIssuer Transaction");
		return entity;
	}
}
