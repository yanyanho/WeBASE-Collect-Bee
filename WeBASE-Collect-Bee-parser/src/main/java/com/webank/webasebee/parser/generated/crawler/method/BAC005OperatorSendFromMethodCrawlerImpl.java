...
import com.webank.webasebee.parser.generated.bo.method.BAC005OperatorSendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.operatorSendFromMethodCrawlerService", havingValue = "on")
public class BAC005OperatorSendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005OperatorSendFrom Transaction");
		BAC005OperatorSendFromBO entity = new BAC005OperatorSendFromBO();
		...
		entity.setTo(AddressUtils.bigIntegerToString(params.get(1).getValue()));
		entity.setAssetId(BigIntegerUtils.toLong(params.get(2).getValue()));
		...
		entity.setIdentifier("BAC005OperatorSendFrom");			
		
		log.debug("end process BAC005OperatorSendFrom Transaction");
		return entity;
	}
}
