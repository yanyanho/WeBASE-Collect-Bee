...
import com.webank.webasebee.parser.generated.bo.method.BAC003IncreaseBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC003.increaseMethodCrawlerService", havingValue = "on")
public class BAC003IncreaseMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC003Increase Transaction");
		BAC003IncreaseBO entity = new BAC003IncreaseBO();
		...
		log.debug("end process BAC003Increase Transaction");
		return entity;
	}
}
