...
import com.webank.webasebee.parser.generated.bo.method.BAC005DestroyBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.destroyMethodCrawlerService", havingValue = "on")
public class BAC005DestroyMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005Destroy Transaction");
		BAC005DestroyBO entity = new BAC005DestroyBO();
		...
		entity.setIdentifier("BAC005Destroy");			
		
		log.debug("end process BAC005Destroy Transaction");
		return entity;
	}
}
