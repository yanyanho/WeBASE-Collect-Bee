...
import com.webank.webasebee.parser.generated.bo.method.BAC005AddSuspenderBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.addSuspenderMethodCrawlerService", havingValue = "on")
public class BAC005AddSuspenderMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005AddSuspender Transaction");
		BAC005AddSuspenderBO entity = new BAC005AddSuspenderBO();
		...
		entity.setIdentifier("BAC005AddSuspender");			
		
		log.debug("end process BAC005AddSuspender Transaction");
		return entity;
	}
}
