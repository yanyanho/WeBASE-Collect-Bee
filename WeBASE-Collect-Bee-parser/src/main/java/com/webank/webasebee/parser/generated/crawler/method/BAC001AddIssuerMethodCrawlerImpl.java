...
import com.webank.webasebee.parser.generated.bo.method.BAC001AddIssuerBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.addIssuerMethodCrawlerService", havingValue = "on")
public class BAC001AddIssuerMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001AddIssuer Transaction");
		BAC001AddIssuerBO entity = new BAC001AddIssuerBO();
		...
		entity.setIdentifier("BAC001AddIssuer");			
		
		log.debug("end process BAC001AddIssuer Transaction");
		return entity;
	}
}
