...
import com.webank.webasebee.parser.generated.bo.method.BAC002SafeSendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.safeSendFromMethodCrawlerService", havingValue = "on")
public class BAC002SafeSendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002SafeSendFrom Transaction");
		BAC002SafeSendFromBO entity = new BAC002SafeSendFromBO();
		...
		entity.setIdentifier("BAC002SafeSendFrom");			
		
		log.debug("end process BAC002SafeSendFrom Transaction");
		return entity;
	}
}
