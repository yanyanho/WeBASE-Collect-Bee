...
import com.webank.webasebee.parser.generated.bo.method.BAC002SendFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC002.sendFromMethodCrawlerService", havingValue = "on")
public class BAC002SendFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC002SendFrom Transaction");
		BAC002SendFromBO entity = new BAC002SendFromBO();
		...
		entity.setIdentifier("BAC002SendFrom");			
		
		log.debug("end process BAC002SendFrom Transaction");
		return entity;
	}
}
