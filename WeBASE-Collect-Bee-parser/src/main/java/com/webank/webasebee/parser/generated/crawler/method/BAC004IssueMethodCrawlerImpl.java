...
import com.webank.webasebee.parser.generated.bo.method.BAC004IssueBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.issueMethodCrawlerService", havingValue = "on")
public class BAC004IssueMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004Issue Transaction");
		BAC004IssueBO entity = new BAC004IssueBO();
		...
		entity.setIdentifier("BAC004Issue");			
		
		log.debug("end process BAC004Issue Transaction");
		return entity;
	}
}
