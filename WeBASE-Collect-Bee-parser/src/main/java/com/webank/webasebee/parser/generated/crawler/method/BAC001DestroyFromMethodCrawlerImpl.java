...
import com.webank.webasebee.parser.generated.bo.method.BAC001DestroyFromBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC001.destroyFromMethodCrawlerService", havingValue = "on")
public class BAC001DestroyFromMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC001DestroyFrom Transaction");
		BAC001DestroyFromBO entity = new BAC001DestroyFromBO();
		...
		entity.setIdentifier("BAC001DestroyFrom");			
		
		log.debug("end process BAC001DestroyFrom Transaction");
		return entity;
	}
}
