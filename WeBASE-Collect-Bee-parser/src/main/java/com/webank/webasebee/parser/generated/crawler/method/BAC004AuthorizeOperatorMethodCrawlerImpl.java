...
import com.webank.webasebee.parser.generated.bo.method.BAC004AuthorizeOperatorBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.authorizeOperatorMethodCrawlerService", havingValue = "on")
public class BAC004AuthorizeOperatorMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004AuthorizeOperator Transaction");
		BAC004AuthorizeOperatorBO entity = new BAC004AuthorizeOperatorBO();
		...
		entity.setIdentifier("BAC004AuthorizeOperator");			
		
		log.debug("end process BAC004AuthorizeOperator Transaction");
		return entity;
	}
}
