...
import com.webank.webasebee.parser.generated.bo.method.BAC004DestroyBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC004.destroyMethodCrawlerService", havingValue = "on")
public class BAC004DestroyMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC004Destroy Transaction");
		BAC004DestroyBO entity = new BAC004DestroyBO();
		...
		entity.setAmount(BigIntegerUtils.toLong(params.get(0).getValue()));
		...
		entity.setIdentifier("BAC004Destroy");			
		
		log.debug("end process BAC004Destroy Transaction");
		return entity;
	}
}
