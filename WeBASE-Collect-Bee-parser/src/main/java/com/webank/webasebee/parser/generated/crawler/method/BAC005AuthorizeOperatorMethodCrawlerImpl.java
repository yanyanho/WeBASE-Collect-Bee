...
import com.webank.webasebee.parser.generated.bo.method.BAC005AuthorizeOperatorBO;

@Slf4j
@Service
@ConditionalOnProperty(name = "monitor.BAC005.authorizeOperatorMethodCrawlerService", havingValue = "on")
public class BAC005AuthorizeOperatorMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	public MethodBO transactionHandler(Transaction transaction, BigInteger blockTimeStamp,
	 Map.Entry<String, String> entry, String methodName, Map<String, String> txHashContractAddress) {
		log.debug("Begin process BAC005AuthorizeOperator Transaction");
		BAC005AuthorizeOperatorBO entity = new BAC005AuthorizeOperatorBO();
		...
		entity.setIdentifier("BAC005AuthorizeOperator");			
		
		log.debug("end process BAC005AuthorizeOperator Transaction");
		return entity;
	}
}
